...
def gamepad_inputs_callback(data):
    global throttle, steering
   
    # cutoff for safety
    throttle = min(max(data.motor,1400.0), 1570.0)
    steering = (data.servo  - 1500) * (35.0 / 500.0) + 90.0

#    print("data.servo = {}, data.motor = {}".format(data.servo, data.motor))
#    print("data.motor = {}".format(throttle))
...
def main_auto():
    ...
    Subscriber('/gamepad_commands', ECU, gamepad_inputs_callback)
